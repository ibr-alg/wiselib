...
#ifndef CONNECTOR_TINYOS_POSITION_H
#define CONNECTOR_TINYOS_POSITION_H
...
namespace wiselib
{
   /** \brief TinyOs Implementation of \ref position_concept "Position Concept"
    *  \ingroup position_concept
    *
    * TinyOs implementation of the \ref position_concept "Position Concept" ...
    */
...
//       typedef PositionType<Float, block_data_P, OsModel_P > position_t;
   ...
   template<typename OsModel_P,
            typename block_data_P,
            typename Float>
   typename TinyOsPositionModel<OsModel_P, block_data_P, Float>::value_t
      TinyOsPositionModel<OsModel_P, block_data_P, Float>::UNKNOWN_POSITION =
