...
#ifndef __SHAWN_LEGACYAPPS_WISELIB_DUTY_CYCLING_PROCESSOR_FACTORY_H
#define __SHAWN_LEGACYAPPS_WISELIB_DUTY_CYCLING_PROCESSOR_FACTORY_H
...
namespace duty_cycling
{
   ...
   class WiselibDutyCyclingProcessorFactory
      : public shawn::ProcessorFactory
   {
   public:
      WiselibDutyCyclingProcessorFactory();
      virtual ~WiselibDutyCyclingProcessorFactory();
