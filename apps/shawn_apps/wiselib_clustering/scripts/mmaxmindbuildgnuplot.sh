...
set xtic auto                          # set xtics automatically
set ytic auto                          # set ytics automatically
set title \"Inform Messages sent\"
set xlabel \"Nodes In Topology\"
set ylabel \"Messages\"
set size 1.0, 0.6
set terminal png 
...
set xtic auto                          # set xtics automatically
set ytic auto                          # set ytics automatically
set title \"Convergecast Messages sent\"
set xlabel \"Nodes In Topology\"
set ylabel \"Messages\"
set size 1.0, 0.6
set terminal png 
...
set xtic auto                          # set xtics automatically
set ytic auto                          # set ytics automatically
set title \"Rejoin Messages sent\"
set xlabel \"Nodes In Topology\"
set ylabel \"Messages\"
set size 1.0, 0.6
set terminal png 
...
set xtic auto                          # set xtics automatically
set ytic auto                          # set ytics automatically
set title \"Maxmind Cluster Head Decision\"
set xlabel \"Nodes In Topology\"
set ylabel \"Rounds\"
set size 1.0, 0.6
set terminal png 
set output \"plots/mmaxmind_chd_"$algo"_"$topologies".png\"
	" >> "$topologies"."$algo".experiments.p
addfiles
...
set xtic auto                          # set xtics automatically
set ytic auto                          # set ytics automatically
set title \"Maxmind Join Decision\"
set xlabel \"Nodes In Topology\"
set ylabel \"Rounds\"
set size 1.0, 0.6
set terminal png 
set output \"plots/mmaxmind_jd_"$algo"_"$topologies".png\"
	" >> "$topologies"."$algo".experiments.p
addfiles
...
set xtic auto                          # set xtics automatically
set ytic auto                          # set ytics automatically
set title \"Maxmind Iterator\"
set xlabel \"Nodes In Topology\"
set ylabel \"Rounds\"
set size 1.0, 0.6
set terminal png 
set output \"plots/mmaxmind_it_"$algo"_"$topologies".png\"
	" >> "$topologies"."$algo".experiments.p
addfiles
...
set size 1.0, 0.6
set terminal png 
set output \"plots/mmaxmind_chd_m_"$algo"_"$topologies".png\"
	" >> "$topologies"."$algo".experiments.p
addfiles
...
set size 1.0, 0.6
set terminal png 
set output \"plots/mmaxmind_jd_m_"$algo"_"$topologies".png\"
	" >> "$topologies"."$algo".experiments.p
addfiles
...
set size 1.0, 0.6
set terminal png 
set output \"plots/mmaxmind_it_m_"$algo"_"$topologies".png\"
	" >> "$topologies"."$algo".experiments.p
addfiles
