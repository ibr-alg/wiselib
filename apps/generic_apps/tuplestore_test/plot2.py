...
from experiment_utils import Situation, Repeat, ExperimentModel, t_average, band_stop, free_ram
...
# abort reading in big .csv when less then this much RAM
# (in bytes) is free (1024**3 == 1 GB)
RAM_MARGIN_READ = 2 * (1024 ** 3)
RAM_MARGIN_PROC = 1 * (1024 ** 3)
...
blacklist += [
    ...
    # some broken/incomplete chopper/find experiments follow
    { 'job': '26349', 'inode_db': 'inode018' },
    { 'job': '26351', 'inode_db': 'inode018' },
    { 'job': '26353', 'inode_db': 'inode020' },
    { 'job': '26357', 'inode_db': 'inode018' },
    { 'job': '26359', 'inode_db': 'inode018' },

    # failed chooper/erase
    { 'job': '25103', 'inode_db': 'inode010'},
    { 'job': '26355'},
    { 'job': '26360'},
    { 'job': '26361'},
    { 'job': '26365'},
    ...
    { 'job': '26388', 'inode_db': 'inode008', '_tmin': 345,}, # '_model_mode': 'relative' },
    { 'job': '26388', 'inode_db': 'inode010'},
    { 'job': '26388', 'inode_db': 'inode014', '_tmin': 340, '_model_mode': 'relative' },
    { 'job': '26388', 'inode_db': 'inode018', '_tmin': 352, '_model_mode': 'relative' },
    { 'job': '26388', 'inode_db': 'inode020', '_tmin': 351, '_model_mode': 'relative' },

    { 'job': '26389', 'inode_db': 'inode008', '_tmin': 370 },
    { 'job': '26389', 'inode_db': 'inode010'},
    { 'job': '26389', 'inode_db': 'inode014', '_tmin': 360, '_model_mode': 'relative' },
    { 'job': '26389', 'inode_db': 'inode016'},
    { 'job': '26389', 'inode_db': 'inode018'},
    { 'job': '26389', 'inode_db': 'inode020'},
    { 'job': '26389', 'inode_db': 'inode022'},
    { 'job': '26389', 'inode_db': 'inode030'},

    # AVL/erase
    { 'job': '26373' },
    { 'job': '26374', 'inode_db': 'inode008', '_tmin': 310 },
    { 'job': '26374', 'inode_db': 'inode010' },
    { 'job': '26374', 'inode_db': 'inode014', '_tmin': 330, '_model_mode': 'relative' },

    { 'job': '26375', 'inode_db': 'inode008', '_tmin': 485 },
    { 'job': '26375', 'inode_db': 'inode010'},
    { 'job': '26375', 'inode_db': 'inode018', '_tmin': 495, '_model_mode': 'relative' },
    
    { 'job': '26376', 'inode_db': 'inode008', '_tmin': 450 },
    { 'job': '26376', 'inode_db': 'inode010' },
    { 'job': '26376', 'inode_db': 'inode014', '_tmin': 460, '_model_mode': 'relative'  },
    { 'job': '26376', 'inode_db': 'inode018', '_tmin': 460, '_model_mode': 'relative'  },
    { 'job': '26376', 'inode_db': 'inode020', '_tmin': 460, '_model_mode': 'relative'  },

    # probably some AVL/erase results in here as well, but we have enough
    { 'job': '26377' },

    { 'job': '26391' }, # teeny without defined operation

    { 'job': '26392', 'inode_db': 'inode008' }, # '_tmax': 15 },
    { 'job': '26392', 'inode_db': 'inode010' },
    { 'job': '26392', 'inode_db': 'inode014',  '_tmax': 15 },
    { 'job': '26392', 'inode_db': 'inode016' },
    { 'job': '26392', 'inode_db': 'inode018',  '_tmax': 15 },
    { 'job': '26392', 'inode_db': 'inode020',  '_tmax': 15 },
    { 'job': '26392', 'inode_db': 'inode022' },
    { 'job': '26392', 'inode_db': 'inode024' },
    { 'job': '26392', 'inode_db': 'inode026' },
    { 'job': '26392', 'inode_db': 'inode028' },
    ...
    { 'job': '26403', 'inode_db': 'inode008', '_tmin': 755 },
    { 'job': '26403', 'inode_db': 'inode010'}, #'_tmin': 740 },
    { 'job': '26403', 'inode_db': 'inode014', '_tmin': 761, '_model_mode': 'relative'},
    { 'job': '26403', 'inode_db': 'inode018'},
    { 'job': '26403', 'inode_db': 'inode020', '_tmin': 760, '_model_mode': 'relative'},
...
def main():
    print('Starting with {} bytes of available RAM'.format(free_ram()))
    ...
    print("------ end. free ram: {}".format(free_ram()))
...
def process_directory(d, f=lambda x: True):
    ...
    for gw, db in gateway_to_db.items():
        ...
        print("reading {} (free ram: {})".format(fn_gwinfo, free_ram()))
    ...
    for ext in ('.csv.gz', '.csv'):
        ...
        if os.path.exists(fn):
            print("  read_energy({}) (free ram: {})".format(fn, free_ram()))
            energy = read_energy(fn, bl, use_subsamples=teenylime or subsample, alpha=(.05 if (teenylime or subsample) else 1.0))
            #es.append(energy)
            print("  procenergy({}) (free ram: {})".format(fn, free_ram()))
            procenergy(energy, d, gw, db, bl, teenylime)
            break
...
def procenergy(energy, d, gw, db, bl, teenylime):
    ...
    for gw, db in gateway_to_db.items():
        ...
        print()
        print("processing: {} -> {} (free ram: {})".format(gw, db, free_ram()))

        if free_ram() <= RAM_MARGIN_PROC:
            print("WARNING: Free RAM ({}) below proc margin ({}).\nSkipping processing of {} -> {}".format(
                free_ram(),
                RAM_MARGIN_PROC,
                gw, db))
            continue
...
maxvalues=v['ntuples'],bl=bl.get(db, {}))
                delta = 0.6
            else:
...
def read_energy(fn, bl, use_subsamples=False, alpha=0.05):
    ...
    #r[mote_id]['ts'][-1] + MEASUREMENT_INTERVAL if len(r[mote_id]['ts']) else 0
        ...
        if free_ram() <= RAM_MARGIN_READ:
            print("WARNING: Free RAM ({}) below read margin ({}).\nStopping reading of {} after {} experiment seconds at line {}".format(
                free_ram(),
                RAM_MARGIN_READ,
                fn, tmax, rownum))
            break
...
def process_energy_ts_erase(d, mode, lbl='', tmin=0, tmax=None, maxvalues=200, bl =None):
    ...
    print("process_energy_ts_erase {} bl={}".format(lbl, bl))

    if '_model_mode' in bl and bl['_model_mode'] == 'relative':
        # first try to determine the baseline
        em = ExperimentModel(
                Situation('start', max = 1.2)
        )
        for m in em.match(ts, vs):
            baseline = m.v_average
        print("-- relative model, preliminary baseline: {}".format(baseline))

        em = ExperimentModel(
                #Situation('idle', max = 1.2, d_min=5.0),
                Situation('start', max = baseline + 0.2),
                Repeat(
...
def process_energy_teenylime(d, mode, lbl='', tmin=0, tmax=None):
    ...
    # Skip power-on bump, then estimate baseline
    em = ExperimentModel(
    ...
    for m in em.match(ts, vs):
        if m.situation.name == 'start':
            baseline = m.v_average
            break

    print("-- teenylime relative model, preliminary baseline: {}".format(baseline))
    ...
    em = ExperimentModel(
            ...
            Situation('start', max=0.25, d_max=.05),
            Repeat(
                Situation('between', max = b + .01),
                Situation('exp', min = b + .005),
                #Situation('after', max = b + .07),
                #Situation('after', min = b + .005),
            )
        )
...
def process_energy_teenylime_(d, mode, lbl='', tmin=0, tmax=None):
    ts = d['ts']
    vs = d['vs']
    fig_energy(ts, vs, lbl)
