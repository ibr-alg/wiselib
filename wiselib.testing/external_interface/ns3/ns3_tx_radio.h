 ...
 ***************************************************************************/
#ifndef CONNECTOR_NS3_TXRADIOMODEL_H
#define CONNECTOR_NS3_TXRADIOMODEL_H
...
namespace wiselib
{
   ...
   class Ns3TxRadioModel
   {
   public:
      typedef OsModel_P OsModel;

      typedef Ns3TxRadioModel<OsModel> self_type;
