 ...
 ***************************************************************************/
#ifndef CONNECTOR_NS3_EXTDATARADIOMODEL_H
#define CONNECTOR_NS3_EXTDATARADIOMODEL_H
...
namespace wiselib
{
   ...
   /** \brief Ns3 Implementation of the extension of \ref radio_concept "Radio concept".
    *  \ingroup extdata_radio_concept
    *  \ingroup radio_concept
    *  \ingroup shawn_facets
    *
    * Ns3 implementation of the extension of the \ref radio_concept "Radio concept" ...
    *
    * @tparam OsModel_P Has to implement @ref os_concept "Os concept".
    */
   template<typename OsModel_P>
   class Ns3ExtendedDataRadioModel
   {
   public:
      typedef OsModel_P OsModel;

      typedef Ns3ExtendedDataRadioModel<OsModel> self_type;
      ...
      // --------------------------------------------------------------------
      Ns3ExtendedDataRadioModel( Ns3Os& os )
         : os_(os),
           node_id_(0)
      {}
      // --------------------------------------------------------------------
