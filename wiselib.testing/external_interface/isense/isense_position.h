 ...
 ***************************************************************************/
#ifndef CONNECTOR_ISENSE_POSITION_H
#define CONNECTOR_ISENSE_POSITION_H
...
//       typedef PositionType<Float, block_data_P, OsModel_P > position_t;
   ...
   template<typename OsModel_P,
            typename block_data_P,
            typename Float>
   typename iSensePositionModel<OsModel_P, block_data_P, Float>::value_t
      iSensePositionModel<OsModel_P, block_data_P, Float>::UNKNOWN_POSITION =
