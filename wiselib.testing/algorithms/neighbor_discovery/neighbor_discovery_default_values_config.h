...
#define ND_MAX_PROTOCOL_PAYLOAD_SIZE 1000 //shawn setting
//#define ND_MAX_PROTOCOL_PAYLOAD_SIZE 20  //setting for ENERGY TESTS
//#define ND_MAX_PROTOCOL_PAYLOAD_SIZE 6 //normal isense
...
#define ND_PAYLOAD_MIN_LINK_STAB_RATIO_THRESHOLD 80
