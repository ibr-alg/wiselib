...
namespace wiselib {
    ...
    public:
        ...
        /**
         * if called with true, from now on be active all sync phases (that is, at the very least listen
         * to incoming beacons), until it is called with false again.
         */
        void set_force_sync_phases(bool force_sync_phases) {
            _force_sync_phases = force_sync_phases;
        }
