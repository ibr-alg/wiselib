 ...
 ***************************************************************************/
#ifndef __ALGORITHMS_TOPOLOGY_KNEIGH_BROADCAST_MSG_H__
#define __ALGORITHMS_TOPOLOGY_KNEIGH_BROADCAST_MSG_H__
...
namespace wiselib
{
   ...
   template<typename OsModel_P,
            typename Radio_P>
   KNeighBroadcastMessage<OsModel_P, Radio_P>::
   KNeighBroadcastMessage()
   {
      set_msg_id( 0 );
   }
