 ...
 ***************************************************************************/
#ifndef __ALGORITHMS_TOPOLOGY_BASIC_TOPOLOGY_BROADCAST_MSG_H__
#define __ALGORITHMS_TOPOLOGY_BASIC_TOPOLOGY_BROADCAST_MSG_H__
...
namespace wiselib
{
   ...
   template<typename OsModel_P,
            typename Radio_P>
   BasicTopologyBroadcastMessage<OsModel_P, Radio_P>::
   BasicTopologyBroadcastMessage()
   {
      set_msg_id( 0 );
   }
