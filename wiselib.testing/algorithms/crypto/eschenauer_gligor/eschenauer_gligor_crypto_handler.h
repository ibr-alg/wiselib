 ...
 ***************************************************************************/
#ifndef ESCHENAUER_GLIGOR_CRYPTO_HANDLER_H
#define ESCHENAUER_GLIGOR_CRYPTO_HANDLER_H
...
namespace wiselib
{
   ...
   public:
      ...
      inline EschenauerGligorCryptoHandler();
   ...
   // -----------------------------------------------------------------------
   template<typename OsModel_P, typename CryptoRoutine_P>
   EschenauerGligorCryptoHandler<OsModel_P, CryptoRoutine_P>::
