 ...
 ***************************************************************************/
#ifndef ESCHENAUER_GLIGOR_MESSAGE_H
#define ESCHENAUER_GLIGOR_MESSAGE_H
...
namespace wiselib
{
   ...
   template<typename OsModel_P,
            typename Radio_P>
   EschenaurGligorMessage<OsModel_P, Radio_P>::
   EschenaurGligorMessage()
   {
      set_msg_id( 0 );
      set_node_id( 0 );
      size_t len = 0;
