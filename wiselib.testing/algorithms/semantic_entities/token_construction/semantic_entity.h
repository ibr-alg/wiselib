	...
	class SemanticEntity {
		public:
			...
			enum HandoverState {
				...
				SEND_ACTIVATING,
				SEND_NONACTIVATING,
				SEND_AGGREGATES_START,
				SEND_AGGREGATES,
				RECV_AGGREGATES_START,
				RECV_AGGREGATES,
				
				AGGREGATES_LOCKED_LOCAL,
				AGGREGATES_LOCKED_LOCAL_1,
				AGGREGATES_LOCKED_LOCAL_2,
				AGGREGATES_LOCKED_LOCAL_GIVE_UP,
				
				AGGREGATES_LOCKED_REMOTE,
				AGGREGATES_LOCKED_REMOTE_1,
				AGGREGATES_LOCKED_REMOTE_2,
				AGGREGATES_LOCKED_REMOTE_GIVE_UP,
