 ...
 ***************************************************************************/
#ifndef __ALGORITHMS_ROUTING_AODV_TYPES_H__
#define __ALGORITHMS_ROUTING_AODV_TYPES_H__
...
namespace wiselib
{
   ...
   {
      RREQ = 140, ///< Msg type for flooding network
      RREP = 141, ///< Msg type for returning found path
      ERR = 142, ///< Msg type for routing messages
      DATA = 145,
      HELO = 146
   };
   // -----------------------------------------------------------------------
