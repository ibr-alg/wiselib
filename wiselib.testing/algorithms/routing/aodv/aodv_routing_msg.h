 ...
 ***************************************************************************/
#ifndef __ALGORITHMS_ROUTING_AODV_ROUTING_MSG_H__
#define __ALGORITHMS_ROUTING_AODV_ROUTING_MSG_H__
...
namespace wiselib
{
   ...
   public:
      ...
      typedef Path_P Path;
      // --------------------------------------------------------------------
      inline AODVRoutingMessage();
      // --------------------------------------------------------------------
      inline AODVRoutingMessage( uint8_t message_id,
   ...
   template <typename OsModel_P,
             typename Radio_P,
             typename Path_P>
   AODVRoutingMessage<OsModel_P, Radio_P, Path_P>::
   AODVRoutingMessage()
   {};
   // -----------------------------------------------------------------------
   template <typename OsModel_P,
             ...
             typename Path_P>
   AODVRoutingMessage<OsModel_P, Radio_P, Path_P>::
   AODVRoutingMessage( uint8_t message_id,
                      uint16_t source, uint16_t destination,
