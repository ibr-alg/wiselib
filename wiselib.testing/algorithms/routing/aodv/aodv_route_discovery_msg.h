 ...
 ***************************************************************************/
#ifndef __ALGORITHMS_ROUTING_AODV_ROUTE_DISCOVERY_MSG_H__
#define __ALGORITHMS_ROUTING_AODV_ROUTE_DISCOVERY_MSG_H__
...
namespace wiselib
{
   ...
   public:
      ...
      // -----------------------------------------------------------------------
      inline AODVRouteDiscoveryMessage(
              uint8_t msg_type,
              uint8_t bcast_id,
              uint8_t hop_cnt,
...
private:
   ...
   template <typename OsModel_P,
             typename Radio_P,
             typename Path_P>
   AODVRouteDiscoveryMessage<OsModel_P, Radio_P, Path_P>::
   AODVRouteDiscoveryMessage(
              uint8_t msg_type,
              uint8_t bcast_id,
              uint8_t hop_cnt,
