...
#ifndef CONSTRUCT_DESCRIPTION_H
#define CONSTRUCT_DESCRIPTION_H

namespace wiselib {
	
	/**
	 * @brief Description of a CONSTRUCT operator.
	 */
	template<
		typename OsModel_P,
		typename Processor_P
	>
	class ConstructDescription : public OperatorDescription<OsModel_P, Processor_P> {
		public:
