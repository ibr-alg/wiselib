...
// #define DPS_COLLECT_STATS
// #define DPS_USE_RPC_HEADER_COMPRESSION
// #define DPS_ENABLE_IPv6_ACKS
...
#define DPS_ACK_MAX_RETRIES 5
...
#else
	#define DPS_GENERAL_TIMER_FREQUENCY 50
	
	//Client DISCOVERY timeouts
	#define DPS_TIMER_DISCOVERY_FREQUENCY 100
	#define DPS_WAIT_FOR_MORE_ADVERTISEMENTS_TIMEOUT 250
	...
	#define DPS_ACK_TIMEOUT 200
	#define DPS_FRAGMENT_COLLECTION_TIMEOUT 1200
