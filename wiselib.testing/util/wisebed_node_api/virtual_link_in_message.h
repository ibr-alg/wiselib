 ...
 ***************************************************************************/
#ifndef CONNECTOR_ISENSE_VIRTUAL_LINK_IN_MESSAGE_H
#define CONNECTOR_ISENSE_VIRTUAL_LINK_IN_MESSAGE_H
...
namespace wiselib
{
   ...
   public:
      ...
      { return read<OsModel, block_data_t, uint8_t>( buffer + REQUESTID_POS); }
      // --------------------------------------------------------------------
      inline void set_request_id( uint8_t request_id )
      { write<OsModel, block_data_t, uint8_t>( buffer + REQUESTID_POS, request_id ); }
      // --------------------------------------------------------------------
      inline uint8_t rssi()
