...
namespace wiselib {
    ...
    public:
        ...
        typedef delegate3<void, uint8_t, uint8_t, uint16_t> cluster_delegate_t;
        ...
        template<class T, void (T::*TMethod)(uint8_t, uint8_t, uint16_t) >
        ...
        void state_changed(uint8_t event, uint8_t type, uint16_t node) {
